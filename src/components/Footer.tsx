      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <span className="text-xl font-bold gradient-text">Cao Hoàng Phúc</span>
        ...
        <div className="mt-8 pt-8 border-t border-dark-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-text-muted text-sm">
            © {currentYear} Cao Hoàng Phúc. All rights reserved.
          </p>
          <p className="text-text-muted text-sm">
            Built with AI using React & Tailwind CSS
          </p>
        </div>
      </div>
    </footer>
